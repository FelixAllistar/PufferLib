...
| WebNav | Three-task pilot simulator/training/evaluator ported; 4,096-step FP32 async/graphs smoke, browser conformance and legacy CPU action-trace parity pass. Larger task families/workflow helpers pending. Obey family build/memory rules. |
