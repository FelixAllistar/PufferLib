...
| Pokemon | Pinned native battle engine and free-pick core/data ported unchanged (no ROM dependency). Bridge and seeded C game tests pass. Environment adapter, semantic model, viewer, resets and league/experiment workflows remain. |
