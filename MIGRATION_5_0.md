...
| WebNav | Three-task Bend pilot, adapter and native CPU-simulator training ported; 4,096-step FP32 async/graphs smoke passes. Browser and task families pending. Obey family build/memory rules. |
