...
| Pokemon | Pinned battle engine, free-pick core/data and semantic CPU model ported unchanged. Bridge/game tests and old/new CPU-model trace parity pass. Environment adapter, CUDA model, viewer, resets and league/experiment workflows remain. |
