...
| WebNav DOM | Existing public DOM-v2 projection/parser ported; browser contract suite passes. Frozen text encoder/cache ported with 1,120 exact tokenizer/vector reference cases and cache contract tests. Pinned asset setup documented. Training environment and learned encoder still pending. |
