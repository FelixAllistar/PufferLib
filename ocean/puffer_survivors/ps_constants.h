...
static_assert(PS_OBS_SIZE == 348, "Unexpected Puffer Survivors observation size");
#else
_Static_assert(PS_OBS_SIZE == 348, "Unexpected Puffer Survivors observation size");
#endif