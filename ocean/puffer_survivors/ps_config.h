...
static inline PSConfig ps_default_config(void) {
    ...
    cfg.reward_xp = 0.0f;
    cfg.reward_kill = 0.0271491f;
    cfg.reward_damage = 0.0f;
    cfg.reward_survival = 0.0051241f;
    cfg.reward_hurt = -1.533688f;
    cfg.reward_death = -1.0f;
    cfg.reward_success = 1.0f;
    cfg.reward_pickup = 0.0200598f;
    cfg.reward_levelup = 0.0396332f;
    cfg.obstacle_penalty = -0.01f;
    cfg.contact_damage = 1.0f;
    cfg.invuln_steps = 36;
    cfg.enemy_obstacle_stride = 1;
    cfg.observation_version = 9;
    cfg.free_upgrade = -1;
    cfg.free_upgrade_count = 0;
    return cfg;
}
