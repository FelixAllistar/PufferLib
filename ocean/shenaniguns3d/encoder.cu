...
struct S3DEncoderWeights {
    Prec scalar1_w, scalar1_b;
    Prec scalar2_w, scalar2_b;
    Prec depth_w, depth_b;
    Prec occupancy_w, occupancy_b;
    Prec proj_w, proj_b;
    int obs_size, hidden;
};
...
struct S3DEncoderActivations {
    Prec saved_input;
    Prec scalar1_out, scalar_out, scalar1_grad;
    Prec depth_out, occupancy_out;
    Prec concat, out;

    Prec scalar1_wgrad, scalar1_bgrad;
    Prec scalar2_wgrad, scalar2_bgrad;
    Prec depth_wgrad, depth_bgrad;
    Prec occupancy_wgrad, occupancy_bgrad;
    Prec proj_wgrad, proj_bgrad;
};
...
static Prec s3d_encoder_forward(void* w, void* activations,
