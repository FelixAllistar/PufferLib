...
`benchmark.py` compares the compiled/wide path against the reference interpreter/full renderer. Historical results files describe earlier experiments and are not current configuration instructions or current full-screen performance claims.
