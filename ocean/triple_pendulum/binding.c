...
void my_init(Env* env, Dict* kwargs) {
    ...
    env->link_mass[0] = dict_get(kwargs, "link1_mass")->value;
    env->link_mass[1] = dict_get(kwargs, "link2_mass")->value;
    env->link_mass[2] = dict_get(kwargs, "link3_mass")->value;
    env->link_length[0] = dict_get(kwargs, "link1_length")->value;
    env->link_length[1] = dict_get(kwargs, "link2_length")->value;
    env->link_length[2] = dict_get(kwargs, "link3_length")->value;
