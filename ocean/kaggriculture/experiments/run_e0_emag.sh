...
# Controlled partner to R0: the only training difference is EMAg.
exec ./puffer train kaggriculture \
    base.run_id=kag_dag_e0_emag \
    ...
    train.ent_coef=0.001 train.emag_kl_coef=0.01 train.emag_tau=0.001 \
