...
`evaluate_macro_clone.py` records expert and predicted macro/quantity/target
diversity, plus the ten most common hard-label opening signatures and
prediction overlap with that expert top ten, making unusual single-agent
openings and shared top-agent openings visible in the report.
