...
tar -C "$kag_tmp" -czf "$kag_output" main.py native_macro_runtime.py \
    native_macro_mode.py native_macro_top_bot.py kaggriculture_v4.bin
echo "Packaged deterministic native macro-mode-$kag_mode agent: $kag_output"
