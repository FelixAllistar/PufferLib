...
import pufferlib
from pufferlib.ocean.multimaze import binding

class Multimaze(pufferlib.PufferEnv):
    def __init__(self, render_mode='raylib', vision_range=5,
            num_envs=4096, num_maps=1000, map_size=-1, max_size=9, close_goal=1,
        ...
        self.c_state = binding.shared(num_maps=num_maps, max_size=max_size, size=map_size, close_goal=close_goal)
